...
This module follows the [Hardware Content Maintenance Conventions (spec/nextra-sidebar-lessons.md §7)](/en/spec/nextra-sidebar-lessons#7-hardware-模块内容维护约定91-100-轮沉淀), covering MDX file specs, mixed-language rules, zh/en sync rhythm, link style, Hub page template, and Build verification.
