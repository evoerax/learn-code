...
下表将 11 层路线图（L0–L10）与本站已有章节一一对应，帮你把勾选路线图与实际页面阅读串联起来。

| 路线图层 | 站内章节 |
|----------|----------|
| Ⅰ · 数理根基 | [编程语言与 Timeline](/zh/timeline)（站外教材补充微积分/线性代数/概率） |
| ② · 电路与电子 | [电路与电子](/zh/hardware/basics/electronics) |
| ③ · 嵌入式与 MCU | [嵌入式与 MCU](/zh/hardware/basics/embedded) |
| ④ · 传感器与感知 | [传感器与感知](/zh/hardware/basics/sensing) |
| ⑤ · 执行器与动力 | [执行器与动力](/zh/hardware/basics/actuation) |
| ⑥ · 控制与估计 | [控制与估计](/zh/hardware/basics/control) |
| ⑦ · 总线与通信 | [总线与通信](/zh/hardware/basics/communication) |
| ⑧ · 机械结构 | [无人机·机架](/zh/hardware/systems/drones/airframe)、[汽车·底盘](/zh/hardware/systems/automotive/by_wire) |
| ⑨ · 智能算法 | [软件总览](/zh/software/overview)、[AI 模型](/zh/ais/overview)、[数据集](/zh/datasets/overview) |
| ⑩ · 整机实战 | [无人机](/zh/hardware/systems/drones)、[汽车](/zh/hardware/systems/automotive)、[机器人](/zh/hardware/systems/robotics) |
| ⑪ · 工程素养 | [无人机·链路与安全](/zh/hardware/systems/drones/link_safety)、[汽车·ADAS](/zh/hardware/systems/automotive/adas)、[机器人·集成安全](/zh/hardware/systems/robotics/integration)（含功能安全/认证/测试） |
...
本文档由 [Hardware 模块内容维护约定（spec/nextra-sidebar-lessons.md §7）](/zh/spec/nextra-sidebar-lessons#7-hardware-模块内容维护约定91-100-轮沉淀) 约束，涉及 MDX 文件规范、混合语言红线规则、中英同步节奏、链接风格、Hub 页结构模板与 Build 验证流程。
